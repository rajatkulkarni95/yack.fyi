...
<main className={`flex min-h-screen flex-col px-4 md:px-8 py-4 xl:py-8 bg-[rgb(25,14,43)]`}>
  ...
  <div className='prose prose-invert mx-auto mt-16 text-center'>
...
![Settings](/changelog/0_6_0_Settings.png)
...
![Search History](/changelog/v0_5_10.png)
...
<video className="w-full rounded-lg" autoPlay loop muted playsInline>
  <source src="/changelog/v0_5_9.mp4" type="video/mp4" />
</video>

**Improvements ✨**

- Allows you to scroll while a stream is ongoing without forcing you down continously. _finally_
- A down arrow is displayed, if you aren't at the extreme bottom, which on click pushes you to the extreme
  bottom and restarts the auto scroll if the stream is ongoing.
- If you manually scroll to the bottom while the stream is ongoing,
  it'll also resume the auto scroll.
